...
void evaluateAllEmissivityAndAbsorption(double* nu, double*** Inu, double*** Anu, int Nnu, double** Ee, double** dFe, int Np, int Nd, double** Bn, double** sintheta, int** thetaIndex, double** concentrations, double concentration, double Bfactor, double fractionSize);
void evaluateAllEmissivityAndAbsorption1(double* nu, double*** Inu, double*** Anu, int Nnu, double** Ee, double** dFe, int Np, int Nd, double** Bn, double** sintheta, int** thetaIndex, double** concentrations, double concentration, double Bfactor, double fractionSize);
...
void evaluateEmissivityAndAbsorptionFlatSimple(double* nu, double* Inu, double* Anu, double* Ee, double* dFe, int Np, int Nnu, double sinhi, double B, double concentration);
#endif