...
void conjugateGradientMethod(std::vector<MatrixElement>**** matrix, double**** rightPart, double**** outVector, int xnumberAdded, int ynumberAdded, int znumberAdded, int additionalBinNumber, int lnumber, double precision, int maxIteration, bool periodic, int verbosity, MPI_Comm& cartComm, int* cartCoord, int* cartDim);
...
void gaussSeidelMethod(std::vector<MatrixElement>**** matrix, double**** rightPart, double**** outVector, int xnumberAdded, int ynumberAdded, int znumberAdded, int additionalBinNumber, int lnumber,
                       int xnumberGeneral, int znumberGeneral, int ynumberGeneral, double precision,
                       int maxIteration, bool periodic, bool startFromZero, int verbocity, MPI_Comm& cartComm, int* cartCoord, int* cartDim);
