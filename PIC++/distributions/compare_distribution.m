...
Color = {'red','green','blue','black','yellow','cyan','magenta',[.5,.5,.5],[.3,.7,.3],[.7,.3,.3]};
...
xlabel ('p/{m_p c}');
ylabel ('F_p(p) p^4');
legend('{\theta}=0','{\theta} = 10','{\theta} = 20','{\theta} = 30','{\theta} = 40','{\theta} = 50','{\theta} = 60','{\theta} = 70','{\theta} = 80','{\theta} = 90','Location','southeast');
grid ;
