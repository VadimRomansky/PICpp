...
const double smoothingParameter = 0.5;
const double smoothingCount = 32;
const double particleSplitLevel = 3;
const double particleSplitAngle = 0.02;
const double speed_of_light_correction = 1.0;
...
const int writeParameter = 5000;
const int writeGeneralParameter = 100;
const int writeTrajectoryNumber = 200;
