...
const double timeEpsilonKourant = 0.02;
const double timeEpsilonFields = 0.02;
const double timeEpsilonPlasma = 0.02;
const double timeEpsilonCapture = 0.02;
...
const int divergenceCleanUpParameter = 10;
