...
const double timeEpsilonFields = 0.1;
const double timeEpsilonPlasma = 0.1;
const double timeEpsilonCapture = 0.1;
...
const int writeParameter = 20000;
const int writeGeneralParameter = 100;
const int writeTrajectoryNumber = 100;
const int writeParticleNumber = 100;
const int writeMemoryParameter = 2000;
const int divergenceCleanUpParameter = 1;
const int filteringParameter = 10;
