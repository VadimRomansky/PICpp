clear;
EfieldY = importdata('EfieldY_5.dat');
BfieldY = inportdata('BfieldY_5.dat');
load Xfile.dat;
load Yfile.dat;
load Zfile.dat;
...
figure(1);
plot (Ygrid(1:Ny-1),Ex(1:Ny-1,1), 'red',Ygrid(1:Ny-1),Ex(1:Ny-1,2), 'green',Ygrid(1:Ny-1),Ex(1:Ny-1,3), 'blue');
%title ('E_x');
xlabel ('y');
ylabel ('E_x gauss');
grid ;
...
figure(2);
plot (Ygrid(1:Ny-1),Ey(1:Ny-1, 1), 'red', Ygrid(1:Ny-1), Ey(1:Ny-1, 2), 'green',Ygrid(1:Ny-1),Ey(1:Ny-1, 3), 'blue');
%title ('E_y');
xlabel ('y');
ylabel ('E_y gauss');
grid ;
...
figure(3);
plot (Ygrid(1:Ny-1),Ez(1:Ny-1, 1), 'red', Ygrid(1:Ny-1), Ez(1:Ny-1, 2), 'green', Ygrid(1:Ny-1), Ez(1:Ny-1, 3), 'blue');
%title ('E_z');
xlabel ('y');
ylabel ('E_z gauss');
grid ;
