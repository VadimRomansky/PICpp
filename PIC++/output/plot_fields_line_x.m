...
for i=1:Nx,
   ...
   Ex(i,2) = EfieldX((i) + b*NE, 1);
   Ex(i,3) = EfieldX((i) + c*NE, 1);
   Ey(i,1) = EfieldX((i) + a*NE, 2);
   Ey(i,2) = EfieldX((i) + b*NE, 2);
   Ey(i,3) = EfieldX((i) + c*NE, 2);
   Ez(i,1) = EfieldX((i) + a*NE, 3);
   Ez(i,2) = EfieldX((i) + b*NE, 3);
   Ez(i,3) = EfieldX((i) + c*NE, 3);
end;
%ynumber = 1;
%znumber = 1;
for i = 1:Nx-1,
   ...
   Bx(i, 1) = BfieldX(i + a*NB, 1);
   Bx(i, 2) = BfieldX(i + b*NB, 1);
   Bx(i, 3) = BfieldX(i + c*NB, 1);
   By(i, 1) = BfieldX(i + a*NB, 2);
   By(i, 2) = BfieldX(i + b*NB, 2);
   By(i, 3) = BfieldX(i + c*NB, 2);
   Bz(i, 1) = BfieldX(i + a*NB, 3);
   Bz(i, 2) = BfieldX(i + b*NB, 3);
   Bz(i, 3) = BfieldX(i + c*NB, 3);
