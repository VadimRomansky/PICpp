...
for i=1:Nz,
   Jx(i,1) = flux(Nz*Ny*(xnumber-1) + Nz*(ynumber-1) + i + a*NE, 1);
   Jx(i,2) = flux(Nz*Ny*(xnumber-1) + Nz*(ynumber-1) + i + b*NE, 1);
   Jx(i,3) = flux(Nz*Ny*(xnumber-1) + Nz*(ynumber-1) + i + c*NE, 1);
   Jy(i,1) = flux(Nz*Ny*(xnumber-1) + Nz*(ynumber-1) + i + a*NE, 2);
   Jy(i,2) = flux(Nz*Ny*(xnumber-1) + Nz*(ynumber-1) + i + b*NE, 2);
   Jy(i,3) = flux(Nz*Ny*(xnumber-1) + Nz*(ynumber-1) + i + c*NE, 2);
   Jz(i,1) = flux(Nz*Ny*(xnumber-1) + Nz*(ynumber-1) + i + a*NE, 3);
   Jz(i,2) = flux(Nz*Ny*(xnumber-1) + Nz*(ynumber-1) + i + b*NE, 3);
   Jz(i,3) = flux(Nz*Ny*(xnumber-1) + Nz*(ynumber-1) + i + c*NE, 3);
