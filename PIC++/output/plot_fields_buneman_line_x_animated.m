...
grid on;
hold on;
axis([Xgrid(1) Xgrid(Nx-1) minEy maxEy]);
fig = plot (Xgrid(1:Nx-1),Ey(1:Nx-1), 'red');
pos = get(gcf, 'Position');
width = pos(3);
height = pos(4);
mov(1:height, 1:width, 1:1, 1:Nt)=0;
...
imwrite(mov, map, 'Ey.gif','DelayTime',frameTime,'LoopCount',1);
...
grid on;
hold on;
axis([Xgrid(1) Xgrid(Nx-1) minEz maxEz]);
fig = plot (Xgrid(1:Nx-1),Ez(1:Nx-1), 'red');
pos = get(gcf, 'Position');
width = pos(3);
height = pos(4);
mov(1:height, 1:width, 1:1, 1:Nt)=0;
...
imwrite(mov, map, 'Ez.gif','DelayTime',frameTime,'LoopCount',1);
...
imwrite(mov, map, 'Bx.gif','DelayTime',frameTime,'LoopCount',1);
...
imwrite(mov, map, 'By.gif','DelayTime',frameTime,'LoopCount',1);
...
imwrite(mov, map, 'Bz.gif','DelayTime',frameTime,'LoopCount',1);