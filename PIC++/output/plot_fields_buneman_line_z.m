clear;
EfieldZ = importdata('EfieldZ_5.dat');
BfieldZ = inportdata('BfieldZ_5.dat');
load Xfile.dat;
load Yfile.dat;
load Zfile.dat;
...
figure(1);
plot (Zgrid(1:Nz-1),Ex(1:Nz-1,1), 'red',Zgrid(1:Nz-1),Ex(1:Nz-1,2), 'green',Zgrid(1:Nz-1),Ex(1:Nz-1,3), 'blue');
%title ('E_x');
xlabel ('z');
ylabel ('E_x gauss');
grid ;
...
figure(2);
plot (Zgrid(1:Nz-1),Ey(1:Nz-1, 1), 'red', Zgrid(1:Nz-1), Ey(1:Nz-1, 2), 'green',Zgrid(1:Nz-1),Ey(1:Nz-1, 3), 'blue');
%title ('E_y');
xlabel ('z');
ylabel ('E_y gauss');
grid ;
...
figure(3);
plot (Zgrid(1:Nz-1),Ez(1:Nz-1, 1), 'red', Zgrid(1:Nz-1), Ez(1:Nz-1, 2), 'green', Zgrid(1:Nz-1), Ez(1:Nz-1, 3), 'blue');
%title ('E_z');
xlabel ('z');
ylabel ('E_z gauss');
grid ;
