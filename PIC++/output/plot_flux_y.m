...
for i=1:Ny,
   Jx(i,1) = flux(Nz*Ny*(xnumber-1) + Nz*(i-1) + znumber + a*NE, 1);
   Jx(i,2) = flux(Nz*Ny*(xnumber-1) + Nz*(i-1) + znumber + b*NE, 1);
   Jx(i,3) = flux(Nz*Ny*(xnumber-1) + Nz*(i-1) + znumber + c*NE, 1);
   Jy(i,1) = flux(Nz*Ny*(xnumber-1) + Nz*(i-1) + znumber + a*NE, 2);
   Jy(i,2) = flux(Nz*Ny*(xnumber-1) + Nz*(i-1) + znumber + b*NE, 2);
   Jy(i,3) = flux(Nz*Ny*(xnumber-1) + Nz*(i-1) + znumber + c*NE, 2);
   Jz(i,1) = flux(Nz*Ny*(xnumber-1) + Nz*(i-1) + znumber + a*NE, 3);
   Jz(i,2) = flux(Nz*Ny*(xnumber-1) + Nz*(i-1) + znumber + b*NE, 3);
   Jz(i,3) = flux(Nz*Ny*(xnumber-1) + Nz*(i-1) + znumber + c*NE, 3);
