...
for i=1:Nx,
   ...
   Bx(i, 1) = Bfield((Nz*Ny*(i-1) + Nz*(ynumber-1) + znumber) + a*NB, 1);
   Bx(i, 2) = Bfield((Nz*Ny*(i-1) + Nz*(ynumber-1) + znumber) + b*NB, 1);
   Bx(i, 3) = Bfield((Nz*Ny*(i-1) + Nz*(ynumber-1) + znumber) + c*NB, 1);
   By(i, 1) = Bfield((Nz*Ny*(i-1) + Nz*(ynumber-1) + znumber) + a*NB, 2);
   By(i, 2) = Bfield((Nz*Ny*(i-1) + Nz*(ynumber-1) + znumber) + b*NB, 2);
   By(i, 3) = Bfield((Nz*Ny*(i-1) + Nz*(ynumber-1) + znumber) + c*NB, 2);
   Bz(i, 1) = Bfield((Nz*Ny*(i-1) + Nz*(ynumber-1) + znumber) + a*NB, 3);
   Bz(i, 2) = Bfield((Nz*Ny*(i-1) + Nz*(ynumber-1) + znumber) + b*NB, 3);
   Bz(i, 3) = Bfield((Nz*Ny*(i-1) + Nz*(ynumber-1) + znumber) + c*NB, 3);
end;
figure(1);
